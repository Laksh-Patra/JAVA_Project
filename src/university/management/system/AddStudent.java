...
public class AddStudent extends JFrame implements ActionListener{
    ...
    long first4 = Math.abs((ran.nextLong() % 9000L)+ 1000L ); //generate random number
    ...
    AddStudent(){
       ...
       JLabel lblname = new JLabel("Name");
        ...
        labelrollno = new JLabel("1501"+first4);
        labelrollno.setBounds(200,200,200,30);
        labelrollno.setFont(new Font("serif",Font.BOLD,15));
        add(labelrollno);
        ...
        lblX.setFont(new Font("serif",Font.BOLD,15));
        add(lblX);
        ...
        lblxii.setFont(new Font("serif",Font.BOLD,15));
        add(lblxii);
